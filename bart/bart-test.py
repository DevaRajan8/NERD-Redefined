...
class FixedMaterialsDataProcessor(MaterialsDataProcessor):
    ...
    def parse_entity_sequence(self, sequence: str) -> list:
        """
        Original parse_entity_sequence method for parsing ground truth data
        Expects format: "entity <sep> type <sep> entity <sep> type"
        """
        ...
        # Parse pairs: entity, type, entity, type, ...
