...
import numpy as np
from bart import CycleNER, MaterialsDataProcessor
...
def plot_results(test_metrics, entity_type_stats, output_prefix="bart"):
    """Create and save comprehensive plots"""
    
    # 1. Overall Performance Metrics
    fig, axes = plt.subplots(2, 2, figsize=(14, 10))
    fig.suptitle('BART Model Performance Metrics', fontsize=16, fontweight='bold')
...
def evaluate_only(checkpoint_path, data_path, model_name='facebook/bart-base'):
    ...
    print(f"{'='*60}")
    plot_results(test_metrics, entity_type_stats, output_prefix="bart")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', type=str, default="./bart_checkpoints_2/final_checkpoint", 
                       help='Path to checkpoint directory')
    parser.add_argument('--data_path', type=str, 
                       default="./solution-synthesis_dataset_2021-8-5.json",
                       help='Path to JSON data file')
    parser.add_argument('--model_name', type=str, default='facebook/bart-base', 
                       help='Facebook model variant')
